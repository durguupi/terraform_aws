...
In this project we will build simple EC2 instance with EBS volume attached to the instance. Using user_data we will mount the volume at the boot 
...
![](scripts/ec2_instance_with_ebs_volume_attached.png)
...
Since we have mounted volume ,its good practise to unmount the volume before destroying the resources otherwise we will face issues while destroying the deployment. 
...
[<img src="screenshots/output1.png" width="800" height="800"/>](screenshots/output1.png) &nbsp;&nbsp;&nbsp;&nbsp; [<img src="screenshots/output2.png" width="1200" height="500"/>](screenshots/output2.png)
